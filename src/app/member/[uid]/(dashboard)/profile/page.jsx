import MemberClassChart from '@/components/chart/MemberClassChart/Index'
...
export default async function Profile({ params }) {
    ...
    return (
        <div >
            <div>
                <div className='bg-blue-100 text-blue-700 rounded-3xl py-10 pt-9 px-5 mr-10 w-full h-1/2'>
